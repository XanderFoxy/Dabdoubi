...
const data = {
  fotos: { title: "Fotos", series: [
    ...
    { name: "Baby Fox", img: null, images: [] }, { name: "Döbeln", img: null, images: [] },
    { name: "Weihnachten", img: prefix+"IMG_0725.jpeg", images: [prefix+"IMG_0725.jpeg"] }, { name: "Italien", img: null, images: [] }
  ]},
  rezepte: { title: "Rezepte", series: [
    ...
    { name: "Lieblingsessen", img: null, images: [] }, { name: "Deutsch", img: null, images: [] },
    { name: "Weihnachten", img: prefix+"Rezepte/IMG_0197.jpeg", images: [prefix+"Rezepte/IMG_0197.jpeg"] }
  ]},
  comics: { title: "Comics", series: [
...
function openSS_from_frame(kat, ser, idx) {
  ...
  const overlay = window.parent.document.getElementById('slideshow-overlay'), img = window.parent.document.getElementById('ss-img');
  img.src = curG[ssIdx]; overlay.classList.add('active');
}
